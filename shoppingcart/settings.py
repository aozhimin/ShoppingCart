...
SECRET_KEY = 'vx29!7m4qxnhr93hq=46e^1(m^elo*5!m^e5u^*uoi!61ure80'
...
FASTCART_PRODUCT_MODEL = 'backend.Product'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'miaowu',                      # Or path to database file if using sqlite3.
        'USER': 'postgres',
        'PASSWORD': '',
...
STATIC_ROOT = '/var/wwwroot/miaowu/static'
